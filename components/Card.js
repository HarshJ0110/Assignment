...
const Card = () => {
  return (
    <>
    <Link href="/posts" style={{color: "blue"}} >Dashboard</Link>
        ...
        <div className="card_container md:max-w-3xl md:max-h-xl md:mx-auto md:bg-white md:flex md:items-center md:rounded-3xl md:shadow-2xl">
            ...
            <div className='login_container md:ml-5 w-screen md:w-80'>
              <form>
                ...
                <p className='mb-9 text-gray-500'>MY DAILY SHOPPING</p>
                <label className='block mb-2 text-gray-500'>E-mail</label>
                <input id="e-mail" type="text" placeholder='example@gmail.com' className='block mb-6 w-full p-2 pl-3 pr-3 border border-gray-400 rounded-md'/>
                <label className='block mb-2 text-gray-500'>Password</label>
                <input id="password" type="text"  placeholder='password' className='w-full p-2 pl-3 pr-3 mb-6 text-gray-500 border border-gray-400 rounded-md'/>
